...
// use fundraiser_pinocchio::instruction::{ContributeInstructionData, InitializeInstructionData};
// use fundraiser_pinocchio::state::{to_bytes, Contribute, Fundraiser};
...
//     unsafe {
//         core::slice::from_raw_parts(&rent as *const Rent as *const u8, Rent::size_of()).tovec()
//     }
// }

// //? Setup common fundraiser accounts
// pub fn setup_fundraiser(
//     mollusk: &Mollusk,
// ) -> (
//     // Pubkeys
//     Pubkey,
...
//         &token_program,
//     );
//     solana_sdk::program_pack::Pack::pack(spl_token::state::Mint {
//         decimals: 6,
//         supply: 100_000,
//         is_initialized: true,
...
//     for _ in 0..9 {
//         let (new_contributor, mut new_contributor_account) =
//             get_new_contributor_account(&mollusk, system_program.clone());
//         let (
//             new_contributor_acc,
